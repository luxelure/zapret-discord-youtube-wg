...
--filter-tcp=443 --dpi-desync=fake,multisplit --dpi-desync-split-pos=1,midsld --dpi-desync-split-seqovl=681 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_www_google_com.bin" --dpi-desync-repeats=4 --dpi-desync-fooling=badseq,md5sig --dpi-desync-fake-tls="%BIN%zero_1.bin" --dpi-desync-fake-tls-mod=none --new ^
