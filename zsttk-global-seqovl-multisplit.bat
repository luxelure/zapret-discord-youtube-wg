...
--filter-tcp=443 --dpi-desync=fake,multisplit --dpi-desync-split-pos=2,midsld --dpi-desync-split-seqovl=681 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_www_google_com.bin" --dpi-desync-repeats=3 --dpi-desync-fooling=badseq,md5sig --dpi-desync-fake-tls=0x00 --new ^
...
--filter-tcp=443 --hostlist="%LISTS%list-youtube.txt" --dpi-desync=fake,multisplit --dpi-desync-split-pos=2,midsld --dpi-desync-split-seqovl=681 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_www_google_com.bin" --dpi-desync-repeats=3 --dpi-desync-fooling=md5sig --dpi-desync-fake-tls=0x00
