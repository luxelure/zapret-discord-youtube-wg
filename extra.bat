...
start "zapret: extra" /min "%BIN%winws.exe" --wf-tcp=80,443 --wf-udp=53-65535 ^
...
--filter-udp=443 --hostlist="%LISTS%list-extra.txt" --dpi-desync=fake --dpi-desync-repeats=11 --new ^
...
--filter-tcp=443 --hostlist="%LISTS%list-extra.txt" --dpi-desync=fake,multidisorder --dpi-desync-split-pos=midsld --dpi-desync-repeats=6 --dpi-desync-fooling=badseq,md5sig --new ^
