...
start "zapret: siberia-custom" /min "%BIN%winws.exe" --wf-tcp=80,443 --wf-udp=53-65535 ^
...
--filter-tcp=443 --hostlist="%LISTS%list-custom.txt" --dpi-desync=fake,multidisorder --dpi-desync-split-pos=midsld --dpi-desync-repeats=8 --dpi-desync-fooling=badseq,md5sig --dpi-desync-fake-tls="%BIN%zero_256.bin" --dpi-desync-fake-tls-mod=none --new ^
--filter-tcp=443 --hostlist="%LISTS%list-discord.txt" --dpi-desync=fake,multidisorder --dpi-desync-split-pos=midsld --dpi-desync-repeats=8 --dpi-desync-fooling=badseq,md5sig --dpi-desync-fake-tls="%BIN%zero_256.bin" --dpi-desync-fake-tls-mod=none --new ^
--filter-tcp=443 --hostlist="%LISTS%list-youtube.txt" --dpi-desync=fake,multidisorder --dpi-desync-split-pos=midsld --dpi-desync-repeats=8 --dpi-desync-fooling=badseq,md5sig --dpi-desync-fake-tls="%BIN%zero_256.bin" --dpi-desync-fake-tls-mod=none
