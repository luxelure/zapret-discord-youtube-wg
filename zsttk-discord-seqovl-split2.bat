...
start "zapret: zsttk-discord-seqovl-split2" /min "%BIN%winws.exe" --wf-tcp=443 --wf-udp=53-65535 ^
...
--filter-tcp=443 --hostlist="%LISTS%list-discord.txt" --dpi-desync=split2 --dpi-desync-split-pos=2 --dpi-desync-split-seqovl=681 --dpi-desync-split-seqovl-pattern="%BIN%tls_clienthello_www_google_com.bin"
