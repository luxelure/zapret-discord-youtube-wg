...
--filter-tcp=443 --hostlist="%LISTS%list-custom.txt" --dpi-desync=fake,multidisorder --dpi-desync-split-pos=midsld --dpi-desync-repeats=8 --dpi-desync-fooling=badseq,md5sig --new ^
