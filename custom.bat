...
--filter-tcp=80 --ipset="%LISTS%ipset-cdn.txt" --dpi-desync=fake,fakedsplit --dpi-desync-autottl=2 --dpi-desync-fooling=md5sig --new ^
...
--filter-udp=443 --ipset="%LISTS%ipset-cdn.txt" --dpi-desync=fake --dpi-desync-repeats=11 --new ^
...
--filter-tcp=443 --ipset="%LISTS%ipset-cdn.txt" --dpi-desync=fake,multidisorder --dpi-desync-split-pos=midsld --dpi-desync-repeats=6 --dpi-desync-fooling=badseq,md5sig --new ^
--filter-tcp=443 --hostlist="%LISTS%list-custom.txt" --dpi-desync=fake,multidisorder --dpi-desync-split-pos=midsld --dpi-desync-repeats=11 --dpi-desync-fooling=badseq,md5sig --new ^
--filter-tcp=443 --hostlist="%LISTS%list-discord.txt" --dpi-desync=fake,multidisorder --dpi-desync-split-pos=midsld --dpi-desync-repeats=8 --dpi-desync-fooling=badseq,md5sig --new ^
