...
start "zapret: zsttk-general-mid" /min "%BIN%winws.exe" --wf-tcp=80,443 --wf-udp=53-65535 ^
...
--filter-tcp=443 --hostlist="%LISTS%list-general.txt" --dpi-desync=fake,multidisorder --dpi-desync-split-pos=midsld --dpi-desync-repeats=6 --dpi-desync-fooling=md5sig,badseq --dpi-desync-fake-tls="%BIN%zero_256.bin" --dpi-desync-fake-tls-mod=none
